          ...
          <div className="m-3 text-justify">
            ...
            <div>
              ...
              <li>
                ...
                ، انصار ، قوامین و کوثر و ... ازسال 92 تا 99
              </li>
              <li>
              ...
              <li>
                جذب 65 نماینده استانی در سراسر کشور به منظورپشتیبانی و پرستاری
                دستگاههای خودپرداز
              </li>
              <br />
            </div>
        ...
        <div className="aboutContainer aboutText">
          <div className="col text-justify">
            ...
            <div>
              ...
              نمایندگان همتا علاوه بر فروش سیم کارت می توانند خدمات دیگری را به
              شرح ذیل نیز به مشتریان خود ارائه و از این محل کسب درآمد نمایند :
              <br />
              <br />
